...
public class Contactanos2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whats = (TextView)findViewById(R.id.txt_whats);
        page = (TextView)findViewById(R.id.txt_pagina);
        face = (TextView)findViewById(R.id.txt_face);
